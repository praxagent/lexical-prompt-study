"""A195 fixed conditional path scoring; injected model/tokenizer, no loader.
...
from . import canonical_answer_ranking_tasks as tasks
from . import special_token_inventory as inventory

SCHEMA = "a195-canonical-answer-ranking-acquisition-v1"
MAX_ENTRIES = 64
MAX_PROMPT = 256
MAX_TARGET = 16
...
class PreparationError(ValueError):
    ...
    def __init__(self, stage, code, original_error_type):
        ...
        super().__init__("a195_preparation_" + stage + "_" + code)
