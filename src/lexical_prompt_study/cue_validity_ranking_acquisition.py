"""A196 fixed conditional path scoring; injected model/tokenizer, no loader.
...
from . import cue_validity_ranking_tasks as tasks
from . import special_token_inventory as inventory

SCHEMA = "a196-cue-validity-ranking-acquisition-v1"
MAX_ENTRIES = 64
MAX_PROMPT = 256
MAX_TARGET = 16
...
class PreparationError(ValueError):
    ...
    def __init__(self, stage, code, original_error_type):
        ...
        super().__init__("a196_preparation_" + stage + "_" + code)
