"""A188 fixed task-load construction, finite oracle and aggregate-only analysis.
...
NAMESPACE = "bf16-arithmetic-load-v1"
SCHEMA = "a188-arithmetic-task-load-v1"
CORE_COUNT = 8
ITEM_COUNTS = (4, 8)
...
def aggregate_records(rows, records):
    ...
    return {
        "schema_version": "a188-task-load-analysis-v1",
